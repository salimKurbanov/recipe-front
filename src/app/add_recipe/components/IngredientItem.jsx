    ...
    return (
        <div className="ingredient_item">
            <div className="ingredient">
                <div className="name">говядина</div>

                <div className="amount">1 кг</div>
            </div>

            <Button mode={'round small'}>
                <svg width="12.002441" height="12.000000" viewBox="0 0 12.0024 12" fill="none">
                    <defs/>
