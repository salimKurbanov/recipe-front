    ...
    return (
        <div className="send_form">
            <div className="agreement">
                ...
                <p className="text">Я соглашаюсь на публикацию моего рецепта и подтверждаю, что у меня есть права на загруженные материалы. Я также ознакомился с <span>правилами размещения рецептов</span> и обязуюсь их соблюдать.</p>
            </div>

            <Button mode={'main green send_btn'}>
                Отправить
